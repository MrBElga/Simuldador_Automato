...
export function ExpressaoRegular() {
  ...
  const handleChangeRegex = () => {
    ...
    if (validate("") === "error") {
      ...
      regex_label.innerHTML =
        "EXPRESSÃO REGULAR <span class='error-msg'>(Erro de síntaxe)</span> ";
  ...
  const handleAddTests = () => {
    ...
    setTests([
      ...tests,
      {
        id: count,
        string: "",
        accepted: validation === "error" ? "" : validation,
      },
    ]);
    setCount(count + 1);
  };
    ...
    <div>
      ...
      <div className="container">
        ...
        <div className="page-content">
          <div className="RegEX">
            <label id="regex-label" htmlFor="regex-input">
              EXPRESSÃO REGULAR
            </label>
            <input
              type="text"
          ...
          <div className="tests-container">
            {tests.map((test) => (
              <div className="string-container" key={test.id}>
                ...
                <div
                  className={`box-string ${test.id === 1 ? "fix-margin" : ""}`}
                >
